...
region. It contains each zone's number of population, workers, goods, and pollution levels. It
...
public:
	Cell();
	enum Type { residential, industrial, commercial, road, powerline, powerlineOverRoad, powerPlant, empty };
